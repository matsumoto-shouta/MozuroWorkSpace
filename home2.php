...
<div class="container">
    ...
    <div class="gallery">
        ...
        if(isset($_SESSION['UserData']['id'])){
            ...
            $sql = "SELECT Picture.picture_ID, Picture.picture_name, UserData.user_ID, UserData.user_name, UserData.user_picture, Upload.caption, COUNT(likes.id) as like_count,
            ...
            if ($stmt->rowCount() > 0) {
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<a href='profile.php?user_id=" . htmlspecialchars($row['user_ID']) . "' class='user-name'>" . htmlspecialchars($row['user_name']) . "</a>";
                    echo "</div>";
