...
<!-- ハンバーガーメニュー -->
<header class="header">
    <div class="logo"><img src="image/instakiro.png" width="48" height="48" style="margin-top: 10px;border-radius: 10px;"></div>
    ...
    <nav class="navigation">
        ...
        <li class="navigation__list-item"><a href="User_list.php" class="navigation__link">ユーザー　ー覧</a></li>
        </ul>
    </nav>
    </header>
    <!-- ここまでハンバーガーメニュー -->
